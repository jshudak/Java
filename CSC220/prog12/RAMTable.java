...
/** Map from word to its disk index.
 *  Uses hash table in RAM.
 *  read and write are for backing it up to disk. */
public class RAMTable extends HashMap<String, Long> {
  ...
  public void write(Disk<List<Long>> wordDisk) {
  ...
  public void read(Disk<List<Long>> wordDisk) {
