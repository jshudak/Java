...
/** Map from URL to disk index.
 *  Uses Trie on disk
 *   Just use is as any Map from String to Long */
public class DiskTrie extends TreeMap<String, Long> {
  ...
  public void write(Disk<PageFile> pageDisk) {
    for (String s : keySet()) {
      trie.add(s, pageDisk.get(get(s)));
    }
  }

  public void read(Disk<PageFile> pageDisk) {
